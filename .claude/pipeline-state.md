...
**Current stage:** 5 — Implementation (in progress — T1-T4 done, T5 unblocked next)
...
| 5. Implementation | (source diffs) | 🔄 In progress — T1-T4 done, T5-T12 remaining, see `impl-plan.md` §2 | `48108be` (T1), `37a9b0d` (T2), `0227677` (T3), `064dac1` (T4) |
...
| T5 — client filter dropdown | ⏳ Not started — unblocked, ready next (depends on T3, T4) | — |
