...
**Current stage:** 5 — Implementation (in progress — T1, T2 done, T3 unblocked next)
...
| 5. Implementation | (source diffs) | 🔄 In progress — T1, T2 done, T3-T12 remaining, see `impl-plan.md` §2 | `48108be` (T1), `37a9b0d` (T2) |
